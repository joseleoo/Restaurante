...
ADD CONSTRAINT IdMesero_fk
  ...
  insert into cliente (identificacion,nombres,apellidos) values(1234,'Diego','Programador')
    insert into cliente (identificacion,nombres,apellidos) values(1235,'juana','David Castro')
	insert into cliente (identificacion,nombres,apellidos) values(1236,'Mariana','Gomes Kleon')
	insert into cliente (identificacion,nombres,apellidos) values(1237,'dorlan','Gomes Kleon')
	insert into mesero (nombres,apellidos,edad,antiguedad) values ('Juana Alexandra', 'Permodo Majarés',30,5)
	insert into mesero (nombres,apellidos,edad,antiguedad) values ('Juan Jose', 'Garces Donald',30,5)
	
insert into plato (nombre,valor) values ('bandeja paisa','10000') 
insert into plato (nombre,valor) values ('masamorra','3000')
insert into plato  (nombre,valor) values ('dulce de guayaba','2000') 
insert into mesa (nombre,reservada,puestos) values ('uno','0','5')
insert into mesa (nombre,reservada,puestos) values ('uno','0','5')
