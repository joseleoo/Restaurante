...
<body>
    ...
    <form id="form1" runat="server">
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col input-group mb-3">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator_txtMesero" ControlToValidate="txtMesero" runat="server"
                                    ...
                                    <div class="col input-group mb-3">
                                        ...
                                        <asp:TextBox ID="txtNombreMesero" aria-required="true" aria-invalid="true" class="form-control"
                                            enable="False" ReadOnly="True" MaxLength="50"
                                            aria-label="Default" aria-describedby="lblMesero" data-toggle="tooltip" required="true" runat="server"></asp:TextBox>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col input-group mb-3">
                                        ...
                                        <asp:TextBox ID="txtCantidad" aria-required="true" aria-invalid="true" class="form-control"
                                            MaxLength="50"
                                            aria-label="Default" aria-describedby="lblCantidad" data-toggle="tooltip" required="true" runat="server"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="col input-group mb-3">
                                        ...
                                        Text="Añadir a la factura" />
                                           <asp:Button ID="btnBorrar" OnClick="btnBorrar_Click" runat="server" class="btn btn-danger"
      ...
      <asp:Button ID="btnSave" OnClick="btnSave_Click" runat="server" class="btn btn-success"
                                        Text="Cerrar compra!" />
                        </div>
